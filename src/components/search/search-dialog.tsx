  ...
  return (
    <>
      <button
        ...
        title="Search  ⌘K"
        data-print="hide"
        className="grid h-10 w-10 sm:h-11 sm:w-11 min-h-[44px] min-w-[44px] place-items-center rounded-full text-content-soft transition hover:bg-content/5 hover:text-content focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent"
      >
