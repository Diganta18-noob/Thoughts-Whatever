...
export function Hero() {
  ...
  return (
    <section className="relative flex min-h-[70svh] flex-col items-center justify-center overflow-hidden px-4 pt-16 pb-12 sm:px-6">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_50%_40%,rgb(var(--surface-raised)/0.9),transparent_70%)]"
      />
      <div
        aria-hidden
